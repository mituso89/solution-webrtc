...
function buildOptions(tenant) {
  return {
    connection: {
      hosts: {
        domain: "tuan-webrtc.online",
        muc: `conference.${tenant}.tuan-webrtc.online`,
        focus: "focus.tuan-webrtc.online",
      },
      serviceUrl: `wss://tuan-webrtc.online/xmpp-websocket?room=${roomName}`,
